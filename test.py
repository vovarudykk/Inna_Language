...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	def check_type(self, row_of_program, symbol_name, class_name):
		# print("Do check_type")
		# print(symbol_name)
		if symbol_name != "int" and symbol_name != "double" and symbol_name != "bool" and symbol_name != "real":
			self.checkError = False
			assert symbol_name == "int" or symbol_name == "double" or symbol_name == "bool" or symbol_name == "real", Syntax.inccorect_type_error.format(row_of_program, symbol_name, class_name)
			sys.exit()
		self.current_number_word += 1
	...
	def parse_factor(self):
		...
		if class_name in ('int', 'double', 'real', 'id', 'bool'):
			...
			self.checkError = False
			assert symbol_name != ';', Syntax.different_instruction.format(row_of_program, symbol_name, class_name, ('int', 'double', 'real', 'id', 'bool'))
			sys.exit()
